        ...
        for (int i = 0; i < maze.length; i++) {
            for (int j = 0; j < maze.length; j++) {
                ...
                if (maze[i][j] == '1') {
                	...
                	AbstractMineFactory mineFactory = new MineMediumFactory(this.gameManager);
	            	...
	            	AbstractPickupFactory mineFactory = new PickupMediumFactory(this.gameManager);
